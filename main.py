...
from utils import set_device, set_seed, load_data, construct_inter, construct_neg, np
...
def load_models(args, config):
    ...
    args.optim = getattr(optim, config["optim"])(args.model.parameters(), lr=args.lr)
